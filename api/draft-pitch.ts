...
const PROPERTIES: Record<string, string> = {
  ...
  'La Costa': 'Gil Hanse-redesigned North Course (2023). Hosting NCAA Division I Championships through 2028. Legacy destination in Carlsbad, CA — 50+ years of golf history.',
  'Amelia Island': '$7.4M Oak Marsh renovation by Beau Welling Design completed May 2025. Oceanfront destination in Florida. Three distinct courses.',
  'Barton Creek': 'Austin, TX golf destination. Pair with PGA Frisco for Texas regional pitches. Fazio-designed courses.',
  'Homestead': '$150M+ renovation completed fall 2023. Historic Hot Springs, VA resort. Cascades Course ranked among America\'s top 50. Oldest continually operating resort in America.',
